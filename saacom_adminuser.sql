...
--
-- Servidor: localhost
-- Tiempo de generación: 22-03-2018 a las 09:37:59
...
--
-- Base de datos: `saacom_adminuser`
--
...
INSERT INTO `centros` (`id`, `nombre`, `cod`) VALUES
(1, 'C.C Patio Trigal', 1),
(2, 'C.C Naguanagua Cyber', 2);
...
INSERT INTO `comentarios` (`idcomentario`, `comentario`, `fecha`, `usuario`, `publicacion`) VALUES
(22, 'Hola yo soy Usuario', '2018-03-21 08:32:54', 2, 27),
(23, 'Hola yo tambien soy nuevo aqui ', '2018-03-21 08:50:01', 4, 27);
...
(1, 1, 1, 1, 'mail.saa.com.ve', 587, 'Cyber Control Evolution', 'registro@saa.com.ve', 'Jose27722772', 'http://www.saa.com.ve/', 'Hola! muchas gracias por registrarte, ahora solo debes de registrar tu cuenta usando el siguiente link', 'Has cambiado de correo electronico! usa el siguiente link para confirmar tu correo electronico', 'Has pedido recuperar tu cuenta, tu nueva contraseña es:');
...
INSERT INTO `contacts` (`idcontacts`, `contact`, `fromcontact`, `fecha`) VALUES
(7, 2, 1, '2018-03-21'),
(8, 1, 2, '2018-03-21'),
(9, 3, 4, '2018-03-21'),
(10, 1, 4, '2018-03-21');
...
INSERT INTO `likepost` (`idlike`, `post`, `user`) VALUES
(2, 13, 5),
(5, 14, 6),
(6, 15, 2),
(7, 16, 2),
...
(4, '2018-03-19 08:25:06', 6, 2, 'Hola ', 'Ya me llego ', 1);
...
INSERT INTO `publicaciones` (`idpublicacion`, `publicacion`, `fecha`, `usuario`) VALUES
(27, 'Hola soy Empresa del Sistema', '2018-03-21 08:29:35', 1);
...
INSERT INTO `tipo_usuario` (`idtipousuario`, `idusuario`, `nombre`) VALUES
(1, 19, 'Empresa'),
(2, 22, 'Usuario'),
(3, 21, 'Tecnico');
...
INSERT INTO `usuarios` (`idusuario`, `nombre`, `idtipousuario`, `apellido`, `ciudad`, `estado`, `navegacion`, `profile`, `email`, `password`, `registro`, `permalink`, `activo`, `ranker`) VALUES
(1, 'Empresa', 1, 'Sistema', 'Valencia', 'Carabobo', 'C.C Patio Trigal', 'sau-content/images/members/normal-0ag5v5zsjt5x2ith2xbxnai9e2018-03-21.jpg', 'empresa@gmail.com', '52688f025164d48b98d2d22a0987cc3c08e6db29', '2018-03-21', '2c2055092d', 2, 2),
(2, 'Usuario', 2, 'Sistema', 'Caracas', 'Distrito Capital', 'C.C Patio Trigal', '1', 'usuario@gmail.com', '52688f025164d48b98d2d22a0987cc3c08e6db29', '2018-03-21', '1c16c993bb', 2, 1),
(3, 'Tecnico', 3, 'Sistema', 'Barcelona', 'Anzuategui', 'C.C Patio Trigal', '1', 'tecnico@gmail.com', '52688f025164d48b98d2d22a0987cc3c08e6db29', '2018-03-21', 'f72894b871', 2, 1),
(4, 'Jose Alberto ', 2, 'Sarmiento Lugo', 'Valencia', 'Carabobo', 'C.C Naguanagua Cyber', '1', 'jose@gmail.com', '52688f025164d48b98d2d22a0987cc3c08e6db29', '2018-03-21', '88cf33437d', 2, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usuarios_widget`
--

CREATE TABLE `usuarios_widget` (
  `id` int(10) NOT NULL,
  `idusuario` int(10) NOT NULL,
  `idwidget` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `usuarios_widget`
--

INSERT INTO `usuarios_widget` (`id`, `idusuario`, `idwidget`) VALUES
(1, 21, 1),
(2, 21, 5),
(3, 21, 4),
(4, 22, 5);
...
(5, '0ac42db69f3aeb985e1901a4cef39e2960f9bf7c', '', '2018-03-19'),
(6, '5100d1b566d5c2743b56a81acbda5a30ba74e5d9', 'josealberto583@gmail.com', '2018-03-19'),
(8, 'c84dad6ed2f083a1628a9ef9f0e27d8c42f9c134', 'cyber@gmail.com', '2018-03-19'),
(16, 'a0409b7d77af4854dbfe1cd400f02be6369fc2ba', 'katherynlabeba@hotmail.com', '2018-03-20'),
(17, 'a0409b7d77af4854dbfe1cd400f02be6369fc2ba', 'katherynlabeba@hotmail.com', '2018-03-20'),
(25, 'fe7621d447c06fedd14f0c2eb842d7c4b4d07a6d', 'ko@gm.com', '2018-03-21'),
(26, '9900be4a64cb41710a420f410385f4fca6bd7405', 'empresa@gmail.com', '2018-03-21'),
(27, 'fb4740a6e982aa58072fc0b4fa390f7b7c440721', 'usuario@gmail.com', '2018-03-21'),
(28, '7245ccadeebb57591cfd27620bd88159116e93dc', 'tecnico@gmail.com', '2018-03-21'),
(29, 'cf5bbb642ada00547db9cb92c461f04cf17740b5', 'jose@gmail.com', '2018-03-21');
...
INSERT INTO `widget` (`id`, `idranker`, `idtipousuario`, `imagen`, `name`, `link`, `display_order`, `created`, `modified`) VALUES
(1, 1, 1, 'sau-content/images/publicaciones.png', 'Publicaciones', 'escritorio', 4, '2018-03-19 23:11:44', '2018-03-19 23:11:44'),
(2, 1, 1, 'sau-content/images/market.png', 'Marketplace', NULL, 5, '2018-03-19 23:11:44', '2018-03-19 23:11:44'),
(3, 2, 1, 'sau-content/images/servicios.png', 'Servicios', NULL, 3, '2018-03-19 23:14:49', '2018-03-19 23:14:49'),
(4, 2, 1, 'sau-content/images/directorio.png', 'Directorio', 'mycontacts', 1, '2018-03-19 23:14:49', '2018-03-19 23:14:49'),
(5, 1, 1, 'sau-content/images/perfil.png', 'Perfil', 'config', 2, '2018-03-20 00:01:18', '2018-03-20 00:01:18'),
(6, 1, 1, 'sau-content/images/recarga.png', 'Recarga Saldo', NULL, 6, '2018-03-20 00:01:18', '2018-03-20 00:01:18'),
(7, 1, 2, 'sau-content/images/recarga.png', 'Recarga Saldo', NULL, 3, '2018-03-20 00:01:18', '2018-03-20 00:01:18'),
(8, 1, 2, 'sau-content/images/perfil.png', 'Perfil', 'config', 2, '2018-03-20 00:01:18', '2018-03-20 00:01:18'),
(9, 2, 2, 'sau-content/images/directorio.png', 'Directorio', 'mycontacts', 1, '2018-03-19 23:14:49', '2018-03-19 23:14:49'),
(10, 2, 3, 'sau-content/images/servicios.png', 'Servicios', NULL, 2, '2018-03-19 23:14:49', '2018-03-19 23:14:49'),
(11, 1, 3, 'sau-content/images/publicaciones.png', 'Publicaciones', 'escritorio', 1, '2018-03-19 23:11:44', '2018-03-19 23:11:44');
...
--
-- Indices de la tabla `usuarios_widget`
--
ALTER TABLE `usuarios_widget`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `contacts`
  MODIFY `idcontacts` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `preferiences`
  MODIFY `idpreference` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `publicaciones`
--
ALTER TABLE `publicaciones`
  MODIFY `idpublicacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
...
--
-- AUTO_INCREMENT de la tabla `usuarios_widget`
--
ALTER TABLE `usuarios_widget`
...
--
ALTER TABLE `verify`
  MODIFY `idactive` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
